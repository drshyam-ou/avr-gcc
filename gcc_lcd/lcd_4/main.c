...
char s[10]="IIT Hyderabd";
// use PortB for LCD interface
 DDRB = 0xFF; // 1111.1111; set PB0-PB7 as outputs	 

 LCD_Init(); // initialize LCD controller
  LCD_Clear();
  LCD_Message("Hyderabad");
 //LCD_Char('s');  // show counter 
 //LCD_Char('h');  // show counter 
 //LCD_Char('y');  // show counter 
 //LCD_Char('a');  // show counter 
 //LCD_Char('m');  // show counter 
 while(1)
 {
